## screen_music.rpy
## Music Player System - Complete English Version
## 
## How to use:
...
init python:
    ...
    def get_character_tracks(character_name):
        """Get track lists for each character"""
        tracks = {
            "amber": [
            ...
            "antonella": [
                ("Antonella's Mystery", antonella_mistery_theme),
...
image music_slideshow_amber:
    "images/music_gallery/amber_01.png"
    pause get_music_slideshow_pause()
    "images/music_gallery/amber_02.png"
    pause get_music_slideshow_pause()
    "images/music_gallery/amber_03.png"
    pause get_music_slideshow_pause()
...
image music_slideshow_elizabeth:
    "images/music_gallery/elizabeth_01.png"
    pause get_music_slideshow_pause()
    "images/music_gallery/elizabeth_02.png"
    pause get_music_slideshow_pause()
...
image music_slideshow_isabella:
    "images/music_gallery/isabella_01.png"
    pause get_music_slideshow_pause()
    "images/music_gallery/isabella_02.png"
    pause get_music_slideshow_pause()
...
image music_slideshow_antonella:
    "images/music_gallery/antonella_01.png"
    pause get_music_slideshow_pause()
    "images/music_gallery/antonella_02.png"
    pause get_music_slideshow_pause()
                    ...
                    hbox:
                        ...
                        if is_playing:
                            ...
                            imagebutton:
                                ...
                                sensitive track_file is not None
                                action Function(mp_toggle_play)
                                style "igm_button"
                                at Transform(zoom=0.8)
                        ...
                        vbox:
                            ...
                            for i, (track_name, track_file) in enumerate(character_tracks):
                                button:
                                    ...
                                    action Function(mp_change_track, i)
                else:
...
## How to integrate this music player in your game:
## 
## 1. In your extras screen or any menu, add a button like this:
##    textbutton "Music Player" action ShowMenu("music_player")
##
## 2. The music player will automatically:
##    - Pause main menu music when opened (even from extras menu)
##    - Stop any playing music player tracks when closed
##    - Resume main menu music when closed (if in main menu)
##    - Play all tracks on the "music1" channel
##    - Remember the current state (selected character, track, volume)
##
## 3. To add new characters or tracks:
##    - Add character images in get_music_character_images()
##    - Add track lists in get_character_tracks()
##    - Add slideshow images for new characters
##
## 4. Required assets:
##    - GUI images: music_player_bg.png, music_dropdown_idle.png, etc.
##    - Character gallery images in images/music_gallery/
##    - Music files referenced in get_character_tracks()
##
## 5. This music player is compatible with your existing audio system
##    and won't interfere with in-game music or sound effects
##
## 6. If main menu music still plays, ensure config.main_menu_music is defined
##    in options.rpy as: define config.main_menu_music = "music/filename.opus"
##
...
##
## TROUBLESHOOTING:
## If main menu music still plays after entering music player:
## 1. Add this debug button to your extras screen temporarily:
##    textbutton "Debug Music" action Function(mp_debug_music)
## 2. Check if your audio system uses different channel names
## 3. Ensure no other code is restarting the music
## 4. The music player now force-stops ALL music channels on entry
##
## ALTERNATIVE SIMPLE SOLUTION:
## If the above doesn't work, try this simpler approach in your extras screen:
## textbutton "Music Player" action [
##     Function(renpy.music.stop, channel="music", fadeout=0),
##     ShowMenu("music_player")
## ]
##
## OR in your extras screen, use this more aggressive approach:
## imagebutton:
