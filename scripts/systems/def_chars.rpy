...
init -999 python:
    def define_characters(patched):
        ...
        characters["amb"] = create_character("Amber", "#FF3333", "#B8F5F5")
        characters["amb_t"] = create_thinking_character("Amber", "#FF3333", "#A6E8E8")
        characters["amb_y"] = create_character("Amber", "#FF3333", "#B8F5F5", '[screaming_bubble]')
        characters["amb_nvl"] = create_nvl_character("Amber", "#FF3333", "#B8F5F5", callback_name="Phone_ReceiveSound")

        characters["anto"] = create_character("Antonella", "#556B2F", "#F5C2F5")
        characters["anto_t"] = create_thinking_character("Antonella", "#556B2F", "#E8B3E8")
        characters["anto_y"] = create_character("Antonella", "#556B2F", "#F5C2F5", '[screaming_bubble]')
        characters["anto_nvl"] = create_nvl_character("Antonella", "#556B2F", "#F5C2F5", callback_name="Phone_ReceiveSound")

        characters["nana"] = create_character("Nanami", "#9B59D0", "#F5F2B8")
        characters["nana_t"] = create_thinking_character("Nanami", "#9B59D0", "#E8E4A6")
        characters["nana_y"] = create_character("Nanami", "#9B59D0", "#F5F2B8", '[screaming_bubble]')
        characters["nana_nvl"] = create_nvl_character("Nanami", "#9B59D0", "#F5F2B8", callback_name="Phone_ReceiveSound")

        characters["mad"] = create_character("Madison", "#2E8B57", "#F5C2C7")
        characters["mad_t"] = create_thinking_character("Madison", "#2E8B57", "#E8B3B8")
        characters["mad_y"] = create_character("Madison", "#2E8B57", "#F5C2C7", '[screaming_bubble]')
        characters["mad_nvl"] = create_nvl_character("Madison", "#2E8B57", "#F5C2C7", callback_name="Phone_ReceiveSound")

        characters["arl"] = create_character("Arlette", "#FF8C00", "#B8D4F5")
        characters["arl_t"] = create_thinking_character("Arlette", "#FF8C00", "#A6C7E8")
        characters["arl_nvl"] = create_nvl_character("Arlette", "#FF8C00", "#B8D4F5", callback_name="Phone_ReceiveSound")

        characters["isa"] = create_character("Isabella", "#00CED1", "#F5B8B8")
        characters["isa_t"] = create_thinking_character("Isabella", "#00CED1", "#E8A6A6")
        characters["isa_y"] = create_character("Isabella", "#00CED1", "#F5B8B8", '[screaming_bubble]')
        characters["isa_nvl"] = create_nvl_character("Isabella", "#00CED1", "#F5B8B8")

        characters["kan"] = create_character("Kanae", "#33ffff", "#FFB8CC")
        characters["kan_nvl"] = create_nvl_character("Kanae", "#33ffff", "#FFB8CC", callback_name="Phone_ReceiveSound")
        ...
        characters["pa_s"] = create_character("Paz", "#DA70D6", "#E8F5B8")
        characters["pa_t"] = create_thinking_character("Paz", "#DA70D6", "#DCE8A6")
        characters["paz_nvl"] = create_nvl_character("Paz", "#DA70D6", "#E8F5B8", callback_name="Phone_ReceiveSound")

        if patched:
            characters["eli"] = Character("Mom", who_color="#CC6699", what_color="#B8F5C2", who_suffix='[dialogue_bubble]', yalign=1)
            characters["eli_y"] = Character("Mom", who_color="#CC6699", what_color="#B8F5C2", who_suffix='[screaming_bubble]', yalign=1)
            characters["mic"] = Character("Dad", who_color="#A9A9A9", what_color="#D4D19A", who_suffix='[dialogue_bubble]', yalign=1)
            characters["eli_nvl"] = create_nvl_character("Mom", "#CC6699", "#B8F5C2", callback_name="Phone_ReceiveSound")
        else:
            characters["eli"] = Character("Elizabeth", who_color="#CC6699", what_color="#B8F5C2", who_suffix='[dialogue_bubble]', yalign=1)
            characters["eli_y"] = Character("Elizabeth", who_color="#CC6699", what_color="#B8F5C2", who_suffix='[screaming_bubble]', yalign=1)
            characters["mic"] = Character("Michael", who_color="#A9A9A9", what_color="#D4D19A", who_suffix='[dialogue_bubble]', yalign=1)
            characters["eli_nvl"] = create_nvl_character("Elizabeth", "#CC6699", "#B8F5C2", callback_name="Phone_ReceiveSound")
