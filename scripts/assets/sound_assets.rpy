...
init -5 python:
    ...
    sfx_categories = {
        "ambient": define_sfx({
            "airplane_interior": "transportation-collection-aircraft-interior-ambience-hum",
            "airbus_flyby": "transports-plane,-airbus-a320-airliner,-flyby",
            "airportwalla": "busy_departure_lounge-_japanese_accent-_new_chitose_airport-_hokkaido-_japan-01_normal_1",
            "applause": "applause-small-group-clapping",
            "ambergameplay": "ambergameplay",
            "birds1": "es_birds-park-3-sfx-producer",
            "beach": "beach",
            "beach2": "beach2",
            "citypast": "es_san-francisco-sfx-producer",
            "clinicwalla": "clinic_basewalla",
            "clinicwalla2": "clinic_beepwalla",
            "clinicwalla3": "clinic_announcingwalla",
            "clinicroom": "clinicroom_basewalla",
            "clinicrooftop": "clinic_rooftop",
            ...
            "fashion": "fashion_backstage",
            "factory": "factory_walla",
            ...
            "night_cicada": "tokyo-ambiences-buzzing-cicadas,-warm-summer-time",
            ...
            "tokyo_residential": "this-is-tokyo-residential-area,-crickets-chirping,-vehicles-passing-by",
            "temple_outside": "temple_outside",
        ...
        "body": define_sfx({
            ...
            "boxing_alone": "boxing-gym-bag-punches",
            "bed_sitdown": "es_bed-sit-down-sfx-producer",
            "bed_laying": "furniture-movements-vol-2-single-bed-jump",
            "bed_creaking": "es_bed-creaks-11-sfx-producer",
            "blood_splash": "blood_splash",
            "changeclothes_nozip": "es_clothes-short-sfx-producer",
            "changeclothes_zip": "raw_fabrics_vol_2_-_37_-_leather_zip",
            "drinking_fem": "drink_water",
            ...
            "footsteps_bare_wood": "wood_barefoot_running",
            ...
            "punch_floor": "punch_floor",
            "punch_glass": "punching_glass",
            ...
            "water_walk": "es_water-walk-wade-slow-sfx-producer",
            "wet_barefoot": "step-it-up-footsteps,-barefoot-on-wet-tile-floor,-walking",
            "yawnfem": "es_yawn-long-female-sfx-producer",
            "yawnnana": "young_woman_reactions_vol_2_-_relief_yawn",
            "yellnana": "nanayell",
        }),
        ...
        "objects": define_sfx({
            ...
            "bodydrop_ontable": "wood_table-_organic",
            "bathtub_sink1": "bathtub1",
            ...
            "door_knock": "es_door-knock-door-1-sfx-producer",
            "door_open2": "es_bedroom-door-open-3-sfx-producer",
            "drop_ontable": "es_textbook-drop-3-sfx-producer",
            "door_front_getin": "front-door-getting-in,-closing-door,-street-to-interior-perspective",
            "digitalcamera1": "digital-cameras-snapping-pictures-with-auto-focus",
            "digitalcamera2": "digital-cameras-slr-flash-popup,-shutter-clicks",
            "digitalcamera3": "digital-cameras-slr-flash-popup,-shutter-clicks-and-beeps",
            "door_glass": "es_door-open-glass-2-sfx-producer",
            "door_bell": "es_bell-store-door-2-sfx-producer",
            ...
            "glass_bottle": "glass-bottle,-picking-up-glass-bottle",
            "glitch": "glitch",
            "hairdryeron": "hairdryer_on",
            "hairdryeroff": "hairdryer_off",
            "hover": "button-click",
            "impact": "ff_et_impact_sparkle",
            "intro_episode": "intro_episode",
            "insect_flying": "es_insect-wings-fly-3-sfx-producer",
            "insect_flying2": "es_insect-wings-fly-4-sfx-producer",
            "keys": "es_door-key-locked-sfx-producer",
            "kick_door": "es_crash-door-kick-open-2-sfx-producer",
            "katana_warn": "katana_warning",
            "katana_sheath_hit": "katana_sheath_hit",
            "kitchen_rumm": "rummingkitchen",
            ...
            "logo": "cute-interface-synth-bells-phrase,-notification",
            "logo_brush": "es_wire-brush-scrape-3-sfx-producer",
            "logo_jp": "cute-interface-far-east-string-arpeggio-notification",
            ...
            "pool_moving": "es_pool-indoor-enter-2-sfx-producer",
            "pool_splash": "swimming-a-water-splash",
            "pool_outof": "swimming-getting-out-of-pool",
            "pool_dive": "swimming-swimmer-single-dive,-water-splash,-close-up",
            "pc_playing_kbm": "typing-playing-video-game,-fast-keyboard-and-mouse-action",
            "pool_surfacing": "swimming-swimmer-surfacing",
            "paper_mov": "es_paper-movement-book-sfx-producer",
            "recordscratch": "tddc_crackle_05_7_inch_45rpm_90",
            "recstop": "es_record-scratch-4-sfx-producer",
            "room_noise": "es_room-tone-23-sfx-producer",
            "room_noise2": "es_room-tone-22-sfx-producer",
            "room_noise3": "room-tones-empty-room,-air-condition-hum,-movements-next-door",
            "rubble": "es_rocks-rattle-sfx-producer",
            ...
            "swing_children": "introvert-rocking-chair,-vintage,-wood-creaking,-slow_1",
            "sofa_move": "furniture-movements-vol-2-heavy-leather-sofa-friction,-sitting-down",
            "scissors_cutting": "barber-scissors,-cutting",
            "shower_faucet": "es_faucet-squeak-2-sfx-producer",
            "taxidoor": "es_police-car-int-sfx-producer",
            "taxihorn": "es_car-horn-honk-61-sfx-producer",
            "tooltip": "bleeping-synth-notes-ni-sound-",
            "tea": "pouring_tea",
            "tea_splash": "throw_cup",
            "tibetantitle": "es_tibetan-instrument-4-sfx-producer",
            "tires_screech": "es_auto-tires-squeal-sfx-producer",
            "tablehit": "vibrant-hits-wood-table-hit",
            "towelshake": "es_towel-shake-out-2-sfx-producer",
            "toweldrop": "es_towel-dry-drop-sfx-producer",
            "unfold": "es_suit-coat-unfold-sfx-producer",
            "vendingmachine": "es_vending-machine-35-sfx-producer",
            "vcall": "videocall",
            "void": "es_drone-empty-void-sfx-producer",
            "wood": "es_table-move-sfx-producer",
            "walletpickup": "es_wallet-pick-up-2-sfx-producer",
            "wardrobe": "odds-and-ends-wardrobe-coat-hangers-squeaking",
            "wings": "flying_flock_of_birds_to_the_food",
            "wings_evil": "jurassic_sounds_-_pterodactyl-_wings_flapping-_flying_v2",
        ...
        "vehicles": define_sfx({
            ...
            "cardoor_open": "es_car-door-open-39-sfx-producer",
            "carcrash": "carcrash",
            "car_driveaway": "driveaway",
            "motorbike_passingby": "triumph-motorcycle-drive-by,-50-mph,-left-to-right",
            "motorbike_stop": "triumph-motorcycle-idle,-strong-revs,-back-perspective",
            "taxiint": "es_car-ride-interior-sfx-producer",
        }),

        "electronics": define_sfx({
            "cameras_photoshoot": "press-conference,-camera-flashing,-walla",
            "camer_shutter": "es_camera-clicks-sfx-producer",
            "cute_igbutton": "cute-interface-bottle-cap-notification",
            "camerashot": "camer_shot",
            "cell_ringtone": "es_cell-ringtone-27-sfx-producer",
        }),

        "human_sounds": define_sfx({
            "applause": "applause-small-group-clapping",
            "bj1": "632000__lesbian-siren__pov-i-m-giving-you-head",
            "children_laugh": "es_children-laughing-sfx-producer",
        ...
        "misc": define_sfx({
            ...
            "clock": "small-clocks-clock-ticking,-analog-clock",
            "chair_rolling": "trivial-foley-rolling-office-chair,-slide",
            "cafewalla": "city-perspectives-cafe,-people-walla,-cashier,-coffee-machine,-edinburgh,-scotland",
            "curtains_open": "household-pulling-curtains,-long-motion",
            "chair_lather_sit": "es_leather-chair-sfx-producer",
            "grass_walk": "es_footsteps-grass-3-sfx-producer",
            "gym_ambience": "ambiences-vol-1-large-gym,-few-people,-reverberant",
            "livingroom": "house-tones-living-room-tone",
            "loud_bg": "this-is-tokyo-loud-construction,-machinery,-hammering",
            "mc_room_night": "worldwide-empty-hotel-room-tone",
            "metro_opendoor": "england-and-ireland-train,-doors-open,-exiting",
            "office": "tel-aviv-ambiences-office,-people-type,-talk",
            "office2": "es_office-walla-light-sfx-producer",
            "officechair_creak": "officechair_creaking",
            "officechair_sit": "officechair_sit",
            "prison": "es_prison-ambience-3-sfx-producer",
            "echodot": "notifications_6",
            "sirens_passby": "emergency-sirens-police-car-siren,-approaching,-passing-by,-left-to-right"
        })
    }
